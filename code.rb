...
puts "There are #{people.count} people."
# * What are the names of all the people?
puts
puts "The names are: #{people.keys}"
...
puts
m_company_people = []
sets_of_people.each do |people_block|
  people_block.each do |key, value|
    if value["company"].downcase.include?("m")
      puts m_company_people.push(key)
    end
  end
end
